...
export const Video = () => {
  ...
  return (
    <div>
      <div className="hero-section">
        <div>
          <h1>
            dalton huey
            <br />
            <span className="h1-symbol">&mdash;</span>videographer
          </h1>
          <p>
            Big and small, I’m passionate about telling stories that matter.
            Perfectly content to be a writer, a director, a DP, or all of them
            at once.
          </p>
        </div>
      ...
      {videos.map((videoProject) => {
        return (
          <VideoProject
            ...
            link={videoProject.youtube_link}
      ...
      <AuthComponent
        component={<NewResourceButton resourceName="Video Project" />}
      />
    </div>
  );
};
